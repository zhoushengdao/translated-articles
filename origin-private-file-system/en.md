...
If you need the fastest possible file operations and/or you deal with [WebAssembly](https://developer.mozilla.org/docs/WebAssembly), skip down to [Using the origin private file system in a Web Worker](#using-the-origin-private-file-system-in-a-web-worker). Else, you can read on.
